...
const userSchema = new mongoose.Schema({
    ...
    googleId: { type: String, index: true, unique: true, sparse: true }, //Sparse allows only not-null value to check for uniqueness i.e. 2 users have null value(If logs using diff. method) , but not 2 users have same google value.
